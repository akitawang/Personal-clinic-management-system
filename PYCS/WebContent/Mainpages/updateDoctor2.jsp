                            ...
                            <h4 class="m-t-0 header-title">可修改医生信息</h4>
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                     ...
                                     <div class="form-group col-md-3">
                                        <label for="inputPassword4" class="col-form-label">密码<span class="text-danger">*</span></label>
                                        <input type="password" class="form-control" id="password" required value=<%=data.getDoctor_password()%> name="password" placeholder="请输入医生密码" pattern="^[a-zA-Z0-9_]{6,16}$" title="只能是6-11位字母、数字、_" >
                                    </div>
                                </div>
                                <div class="form-row">
                                <div class="form-group col-md-3">
