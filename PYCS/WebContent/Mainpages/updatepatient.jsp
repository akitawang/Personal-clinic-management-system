    ...
    <body>
        ...
        <!-- Form row -->
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title">修改信息</h4>
                            
                            <p class="text-muted m-b-30 font-13">
                                	请准确填写 <code class="highlighter-rouge">病人</code> 的 <code class="highlighter-rouge">个人信息</code>，带有*标记的内容必须填写，其他可不填。
                            </p>

                            <form action="/PYCS/UpdatePatient" method="post" onsubmit="return verify()">
                                <div class="form-row">
                                
                                       <div class="form-group col-md-3">
                                        <label for="name" class="col-form-label">排队序号<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" value="<%=bean.getPatient_list()%>"  required name="list" readonly="readonly">
                                    </div>
                                
                                    <div class="form-group col-md-3">
                                        <label for="name" class="col-form-label">姓名<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" value="<%=bean.getPatient_name()%>"  required name="name" placeholder="请输入 姓名">
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="phone" required   value="<%=bean.getPatient_phone()%>"  onkeyup="value=value.replace(/[^\d]/g,'')" name="phone" placeholder="请输入 电话号码">
                                    </div>
                                ...
                                <div class="form-group col-md-3">
                                   ...
                                   <div>
                                       <div class="input-group">
                                           <input type="text" class="form-control" required    value="<%=bean.getPatient_birth()%>"  readonly placeholder="mm/dd/yyyy" name="birth" id="datepicker">
                                ...
                                <div class="form-group col-md-2">
                                        ...
                                        <input type="text"    value="<%=bean.getPatient_weight()%>"   class="form-control" id="weight" onkeyup="value=value.replace(/[^\d]/g,'')" name="weight" placeholder="请输入体重">
                                </div>
                            <div class="form-group col-md-2">
                                        <label for="gender" class="col-form-label">是否在队列<span class="text-danger">*</span></label>
                                    <div class="col-sm-15">
                               ...
                               <div class="form-group col-md-3">
                                        <label for="bloodtype" class="col-form-label">身份证号</label>
                                        <input type="text" class="form-control" id="id"  value="<%=bean.getPatient_id()%>"  name="id" placeholder="请输入 身份证号">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"    value="<%=bean.getPatient_address()%>"   id="address" name="address" placeholder="请输入 家庭住址">
                                </div>
