                            ...
                            <form action="/PYCS/Create_prescription_servlet" method="post" onsubmit="return verify()">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="phone" required  name="phone" placeholder="请输入患者电话号码">
                                    </div>
                                    <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control" id="weight" name="weight" placeholder="请输入患者体重">
                                </div>
                                <div class="form-group col-md-2">
                                        <label for="bloodtype" class="col-form-label">身高(单位：厘米)</label>
                                        <input type="text" class="form-control" id="height" name="height" placeholder="请输入患者身高">
                                </div>
								</div>
