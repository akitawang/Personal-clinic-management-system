    ...
    <body>
        ...
        <!-- Form row -->
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title">增添医生</h4>
                            
                            

                            <form action="/PYCS/AddDoctor" method="post" onsubmit="return verify()">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="name" class="col-form-label">姓名<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control"  required name="name" placeholder="请输入医生姓名">
                                    </div>
    
                                   
                                    <div class="form-group col-md-3">
                                        <label for="inputPassword4" class="col-form-label">电话号码<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="phone" required  name="phone" placeholder="请输入医生电话号码" pattern="^[0-9]{11,11}$" title="只能是11位数字" >
                                    </div>
                                      <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                   ...
                                   <div>
                                       <div class="input-group">
                                           <input type="inputPassword4" class="form-control" required  placeholder="mm/dd/yyyy" name="birth" id="datepicker">
                                ...
                                <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="dep" required  name="dep" placeholder="请输入医生科室">
                                    </div>
                                 <div class="form-group col-md-3">
                                        <label for="inputPassword4" class="col-form-label">员工编号<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="id" required  name="id" placeholder="请输入医生员工编号">
                                    </div>
								</div> 
