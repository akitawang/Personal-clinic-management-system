...
public class cases {
	...
	private String Case_phone;     //�ͻ��绰����
	private String Case_weight;    //�ͻ�����
	private String Case_address;   //�ͻ���ͥסַ
	private String Case_allergy;   //�ͻ�����ʷ
	private String Case_height;    //�ͻ����
	private String Case_type;      //�ͻ�Ѫ��
	private String Case_symptom;   //�ͻ�֢״
	private String Case_info;      //�����Ϣ
