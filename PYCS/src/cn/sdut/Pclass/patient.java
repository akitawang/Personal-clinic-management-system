...
public class patient {
	...
	private String Patient_zt;
	private String Patient_address;  //�ͻ���ͥסַ
	private int Patient_list;     //�ͻ��Ŷ����
	...
	public String getPatient_zt() {
		return Patient_zt;
	}

	public void setPatient_zt(String patient_zt) {
		Patient_zt = patient_zt;
	}
	...
	public int getPatient_list() {
		return Patient_list;
	}

	public void setPatient_list(int patient_list) {
		Patient_list = patient_list;
	}

	public patient(String patient_name, String patient_sex, String patient_birth, String patient_weight,
			String patient_id, String patient_phone, String patient_zt, String patient_address, int patient_list) {
		super();
		Patient_name = patient_name;
		Patient_sex = patient_sex;
		Patient_birth = patient_birth;
