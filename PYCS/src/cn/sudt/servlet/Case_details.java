...
/**
 * Servlet implementation class Cases_details
 */
public class Case_details extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String case_num = request.getParameter("id");
		...
		try {
			...
			request.getRequestDispatcher("/Mainpages/cases_details.jsp").forward(request, response);
	}
